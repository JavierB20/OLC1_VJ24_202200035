...
public class AsignacionVec extends Instruccion{
    ...
    public AsignacionVec(String id, Instruccion Dimension1, Instruccion Dimension2, Instruccion expresion, Tipo tipo, int linea, int col) {
    ...
    public AsignacionVec(String id, Instruccion Dimension1, Instruccion expresion, Tipo tipo, int linea, int col) {
        super(tipo, linea, col);
        this.id = id;
        this.Dimension1 = Dimension1;
        this.expresion = expresion;
...
//        boolean asignacion = (boolean)vector.setValor(nuevoValor);
//        if (!asignacion) {
